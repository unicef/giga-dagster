...
def define_dataset_properties(
    ...
    custom_metadata: dict[str, str] = {
        ...
        "Dagster Version": str(version.__version__),
        "Dagster Run ID": str(context.run_id),
        ...
        "Dagster Op Name": str(context.op_def.name),
        "Dagster Job Name": str(context.job_def.name),
        "Dagster Run Created Timestamp": start_time,
        "Dagster Sensor Name": str(context.run_tags.get("dagster/sensor_name")),
