...
def transform_school_master_types(
    ...
    transform_columns(df, columns_convert_to_string, types.StringType(), context)
    transform_columns(df, columns_convert_to_double, types.DoubleType(), context)
    transform_columns(df, columns_convert_to_int, types.IntegerType(), context)
    transform_columns(df, columns_convert_to_long, types.LongType(), context)
    transform_columns(df, columns_convert_to_timestamp, types.TimestampType(), context)
