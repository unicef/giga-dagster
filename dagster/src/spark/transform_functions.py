...
if __name__ == "__main__":
    ...
    # file_url = f"{connection_uri}/bronze/school-geolocation/SEN/wwx7232jufo9htsuq595zy07_SEN_geolocation_20240610-163027.csv"
    file_url_master = f"{connection_uri}/updated_master_schema/master/BRA_school_geolocation_coverage_master.csv"
    file_url_reference = (
        f"{connection_uri}/updated_master_schema/reference/BRA_master_reference.csv"
    )
