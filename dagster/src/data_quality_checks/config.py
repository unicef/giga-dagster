...
CONFIG_AGGREGATE_SUM = {
    "master": config.AGGREGATE_SUM_COLUMNS,
    "geolocation": config.AGGREGATE_SUM_COLUMNS,
}
CONFIG_AVAILABILITY_FROM_COUNT = {
    "master": config.AVAILABILITY_FROM_COUNT_COLUMNS,
    "geolocation": config.AVAILABILITY_FROM_COUNT_COLUMNS,
}
