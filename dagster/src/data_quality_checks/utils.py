...
def row_level_checks(
    ...
    if dataset_type in ["master", "geolocation"]:
        ...
        df = standard_checks(df, dataset_type, context, duplicate=False, domain=False, range_=False, format_=False)
    return df
...
if __name__ == "__main__":
    ...
    file_url_qos = f"{settings.AZURE_BLOB_CONNECTION_URI}/gold/qos/BRA/2024-03-07_04-10-02.csv"
