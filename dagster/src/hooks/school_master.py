    ...
    with get_db_context() as db:
        ...
        if file_upload and file_upload.source == "gigameter":
            ...
            if school_id_giga:
                ...
                _write_to_nocodb(context, file_upload)
    ...
    with get_db_context() as db:
        ...
        if file_upload and file_upload.source == "gigameter":
            ...
            if school_id_giga:
                ...
                _call_gigameter_soft_delete(context, school_id_giga, failure_reason)


def _write_to_nocodb(context: HookContext, file_upload: FileUpload) -> None:
    """Write approved school registration to NoCoDB."""
    ...
    try:
        ...
        record_data = {
            ...
            "longitude": float(mapping.get("longitude", 0)),
...
def _call_gigameter_soft_delete(
    ...
    try:
        ...
        context.log.info(
            f"GigaMeter soft-delete successful for school_id_giga={school_id_giga}"
        )
