    ...
    for file_data in paths_list:
        ...
        ops_destination_mapping = {
            ...
            "adhoc__master_data_transforms": OpDestinationMapping(
                source_filepath=str(path),
                destination_filepath=f"{constants.gold_folder}/dq-results/school-master/transforms/{stem}.parquet",
                metastore_schema=master_metastore_schema,
                tier=DataTier.TRANSFORMS,
            ),
            "adhoc__df_duplicates": OpDestinationMapping(
                source_filepath=f"{constants.gold_folder}/dq-results/school-master/transforms/{stem}.parquet",
            ...
            "adhoc__master_data_quality_checks": OpDestinationMapping(
                source_filepath=f"{constants.gold_folder}/dq-results/school-master/transforms/{stem}.parquet",
                destination_filepath=f"{constants.gold_folder}/dq-results/school-master/full/{stem}.parquet",
                metastore_schema=master_metastore_schema,
                tier=DataTier.DATA_QUALITY_CHECKS,
            ),
            "adhoc__reference_data_quality_checks": OpDestinationMapping(
                source_filepath=str(reference_path),
                destination_filepath=f"{constants.gold_folder}/dq-results/school-reference/full/{reference_stem}.parquet",
                metastore_schema=reference_metastore_schema,
                tier=DataTier.DATA_QUALITY_CHECKS,
            ),
            ...
            "adhoc__master_dq_checks_passed": OpDestinationMapping(
                source_filepath=f"{constants.gold_folder}/dq-results/school-master/full/{stem}.parquet",
                destination_filepath=f"{constants.gold_folder}/dq-results/school-master/passed/{stem}.parquet",
                metastore_schema=master_metastore_schema,
                tier=DataTier.DATA_QUALITY_CHECKS,
            ),
            "adhoc__reference_dq_checks_passed": OpDestinationMapping(
                source_filepath=f"{constants.gold_folder}/dq-results/school-reference/full/{reference_stem}.parquet",
                destination_filepath=f"{constants.gold_folder}/dq-results/school-reference/passed/{reference_stem}.parquet",
                metastore_schema=reference_metastore_schema,
                tier=DataTier.DATA_QUALITY_CHECKS,
            ),
            ...
            "adhoc__publish_reference_to_gold": OpDestinationMapping(
                source_filepath=f"{constants.gold_folder}/dq-results/school-reference/passed/{reference_stem}.parquet",
