...
CREATE TABLE delta_lake.test_tables.all_gigameter_valid_test_checker_incremental

WITH (
    location = 'abfss://giga-dataops-prod@saunigiga.dfs.core.windows.net/warehouse/all_gigameter_valid_test_checker_incremental'
)
AS
