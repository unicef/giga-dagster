CREATE TABLE delta_lake.test_tables.all_mlab_only_measurements_incremental
WITH (
    location = 'abfss://giga-dataops-prod@saunigiga.dfs.core.windows.net/warehouse/all_mlab_only_measurements_incremental'
)
AS
