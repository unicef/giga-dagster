-- ==============================================================================
-- Script Name:     all_gigameter_school_percentile_distributions.sql
-- Table Created:   default.all_gigameter_school_percentile_distributions
-- Schema:          default
-- Pipeline Status: Active (Integrated: true)
--
-- Purpose:
--   Per-school percentile distributions (p25/p50/p75/p90/p95) of GigaMeter
--   speed-test metrics, restricted to in-school-hours measurements
--   (8am-4pm). One row per school.
--
-- Dependencies:
--   - default.all_gigameter_measurement_data
--
-- Output Columns:  27 columns
-- Primary Key:     school_id_govt
