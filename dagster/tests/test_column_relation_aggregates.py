...
class TestAvailabilityIsCaseInsensitive:
    @pytest.mark.parametrize("supplied", ["yes", "YES", "Yes"])
    def test_any_casing_counts_as_yes(self, spark, supplied):
        check = aggregate_relation_check_name(
