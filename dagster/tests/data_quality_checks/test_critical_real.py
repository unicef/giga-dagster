...
def test_critical_error_checks_logic(spark_session):
    ...
    mock_mapping = {
        "dq_is_null_mandatory-id": "id is null",
        "dq_duplicate-school_id_govt": "duplicate school_id_govt",
        "dq_duplicate-school_id_giga": "duplicate school_id_giga",
        "dq_is_null_mandatory-latitude": "latitude is null",
        "dq_is_null_mandatory-longitude": "longitude is null",
        "dq_is_invalid_range-latitude": "latitude is invalid",
        "dq_is_invalid_range-longitude": "longitude is invalid",
        "dq_is_not_within_country": "not within country",
        "dq_is_not_create": "is not create",
    }
